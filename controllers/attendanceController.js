...
exports.attendAutomaticallyStudents = catchAsync(async(req,res,next)=>{
...
exports.test1 = catchAsync(async(req,res,next)=>{

    console.log("yes I am test1")
